...
> โปรแกรมเมอร์รุ่นพี่แนะนำเทคนิคว่า ถ้าอยากเขียนโปรแกรมเก่งๆ ให้หมั่นเขียนบทความ

ขอเริ่มเลยแล้วกัน ปุ่ม "Sign in with Google" ที่เห็นสวยๆนี้ มันมีการทำงานแยกได้เป็น 2 ส่วนคือ
...
2. ส่วนของการประมวลผล \(เอาโค๊ดไปใส่ใน app.js หรือ server.js แล้วแต่เราจะตั้งชื่อ\)
